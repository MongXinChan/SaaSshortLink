...
import com.MongxinChan.SaaSshortLink.admin.remote.dto.req.ShortLinkBatchCreateReqDTO;
...
import com.MongxinChan.SaaSshortLink.admin.remote.dto.resp.ShortLinkBatchCreateRespDTO;
...
public interface ShortLinkRemoteService {
    ...
    default Result<ShortLinkCreateRespDTO> createShortLink(ShortLinkCreateReqDTO requestParam) {
        String resultBodyStr = HttpUtil.post("http://127.0.0.1:8001/api/saas-short-link/v1/create",
     ...
     * @return 短链接批量创建响应
     */
    default Result<ShortLinkBatchCreateRespDTO> batchCreateShortLink(
            ShortLinkBatchCreateReqDTO requestParam) {
        String resultBodyStr = HttpUtil.post(
                "http://127.0.0.1:8001/api/saas-short-link/v1/create/batch",
                JSON.toJSONString(requestParam));
        return JSON.parseObject(resultBodyStr, new TypeReference<>() {
        });
    }
    ...
    default void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        HttpUtil.post("http://127.0.0.1:8001/api/saas-short-link/v1/update",
                JSON.toJSONString(requestParam));
    }
    ...
    default Result<List<ShortLinkGroupCountQueryRespDTO>> listGroupShortLinkCount(
        ...
        String resultPageStr = HttpUtil.get("http://127.0.0.1:8001/api/saas-short-link/v1/count",
                requestMap);
        return JSON.parseObject(resultPageStr, new TypeReference<>() {
        });
    }
    ...
    default Result<String> getTitleByUrl(@RequestParam("url") String url) {
        String resultStr = HttpUtil.get(
                "http://127.0.0.1:8001/api/saas-short-link/v1/title?url=" + url);
    ...
    default void saveRecycleBin(RecycleBinSaveReqDTO requestParam) {
        HttpUtil.post("http://127.0.0.1:8001/api/saas-short-link/v1/recycle-bin/save",
                JSON.toJSONString(requestParam));
    }
     ...
     * @return 查询短链接响应
     */
    default Result<IPage<ShortLinkPageRespDTO>> pageRecycleBinShortLink(
    ...
    default void removeRecycleBin(RecycleBinRemoveReqDTO requestParam) {
        HttpUtil.post("http://127.0.0.1:8001/api/saas-short-link/v1/recycle-bin/remove",
                JSON.toJSONString(requestParam));
    }
     ...
     * @return 分组短链接监控信息
     */
    default Result<ShortLinkStatsRespDTO> groupShortLinkStats(
            ShortLinkGroupStatsReqDTO requestParam) {
        String resultBodyStr = HttpUtil.get(
                "http://127.0.0.1:8001/api/saas-short-link/v1/stats/group",
    ...
    default Result<IPage<ShortLinkStatsAccessRecordRespDTO>> groupShortLinkStatsAccessRecord(
        ...
        String resultBodyStr = HttpUtil.get(
                "http://127.0.0.1:8001/api/saas-short-link/v1/stats/access-record/group",
                stringObjectMap);
        return JSON.parseObject(resultBodyStr, new TypeReference<>() {
        });
    }
