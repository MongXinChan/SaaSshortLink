...
import static com.MongxinChan.SaaSshortLink.project.common.constant.ShortLinkConstant.AMAP_REMOTE_URL;
...
import com.MongxinChan.SaaSshortLink.project.config.GotoDomainWhiteListConfiguration;
...
import com.MongxinChan.SaaSshortLink.project.toolkit.LinkUtil;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements
    ...
    @Value("%{saas-short-link.domain.default}")
    ...
    public void restoreUrl(String shortUri, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            LambdaQueryWrapper<ShortLinkGotoDO> linkGotoQueryWrapper = Wrappers.lambdaQuery(
    ...
    private void shortLinkStats(String fullShortUrl, String gid, ServletRequest request,
        ...
        try {
            ...
            String remoteAddr = LinkUtil.getActualIp(((HttpServletRequest) response));
            Long uipAdded = stringRedisTemplate.opsForSet()
                    .add("short-link:status:uv:" + fullShortUrl, remoteAddr);
            Boolean uipFirstFlag = uipAdded != null && uipAdded > 0L;


            if (StrUtil.isBlank(gid)) {
                LambdaQueryWrapper<ShortLinkGotoDO> queryWrapper = Wrappers.lambdaQuery(
                                ShortLinkGotoDO.class)
                        .eq(ShortLinkGotoDO::getFullShortUrl, fullShortUrl);
            ...
            if (StrUtil.isNotBlank(infoCode) && StrUtil.equals(infoCode, "10000")) {
                ...
                LinkLocateStatsDO linkLocateStatsDO = LinkLocateStatsDO.builder()
                        ...
                        .city(actualCity = unknownFlag ? "位置" : locateResultObj.getString("city"))
