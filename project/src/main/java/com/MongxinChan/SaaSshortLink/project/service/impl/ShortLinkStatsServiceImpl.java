...
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsAccessDailyRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsAccessRecordRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsBrowserRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsDeviceRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsLocateCNRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsNetworkRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsOsRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsTopIpRespDTO;
import com.MongxinChan.SaaSshortLink.project.dto.resp.ShortLinkStatsUvRespDTO;
import com.MongxinChan.SaaSshortLink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        // 基础访问数据
        LinkAccessStatsDO pvUvUidStatsByShortLink = linkAccessLogsMapper.findPvUvUidStatsByShortLink(
                requestParam);
        // 基础访问详情
        List<LinkAccessStatsDO> listStatsByShortLink = linkAccessStatsMapper.listStatsByShortLink(
                requestParam);
        // 地区访问详情（仅国内）
        List<ShortLinkStatsLocateCNRespDTO> locateCnStats = new ArrayList<>();
        List<LinkLocateStatsDO> listedLocateByShortLink = linkLocateStatsMapper.listLocateByShortLink(
                requestParam);
        ...
        List<LinkAccessStatsDO> listHourStatsByShortLink = linkAccessStatsMapper.listHourStatsByShortLink(
                requestParam);
        for (int i = 0; i < 24; i++) {
        ...
        List<HashMap<String, Object>> listTopIpByShortLink = linkAccessLogsMapper.listTopIpByShortLink(
                requestParam);
        ...
        List<LinkAccessStatsDO> listWeekdayStatsByShortLink = linkAccessStatsMapper.listWeekdayStatsByShortLink(
                requestParam);
        for (int i = 0; i < 7; i++) {
        ...
        List<HashMap<String, Object>> listOsStatsByShortLink = linkOsStatsMapper.listOsStatsByShortLink(
                requestParam);
        ...
        HashMap<String, Object> findUvTypeByShortLink = linkAccessLogsMapper.findUvTypeCntByShortLink(
                requestParam);
        ...
        List<LinkDeviceStatsDO> listDeviceStatsByShortLink = linkDeviceStatsMapper.listDeviceStatsByShortLink(
                requestParam);
        ...
        List<LinkNetworkStatsDO> listNetworkStatsByShortLink = linkNetworkStatsMapper.listNetworkStatsByShortLink(
                requestParam);
        ...
        return ShortLinkStatsRespDTO.builder()
                ...
                .daily(BeanUtil.copyToList(listStatsByShortLink,
                        ShortLinkStatsAccessDailyRespDTO.class))
    ...
    public IPage<ShortLinkStatsAccessRecordRespDTO> shortLinkStatsAccessRecord(
        ...
        LambdaQueryWrapper<LinkAccessLogsDO> queryWrapper = Wrappers.lambdaQuery(
                        LinkAccessLogsDO.class)
        ...
        IPage<LinkAccessLogsDO> linkAccessLogsDOIPage = linkAccessLogsMapper.selectPage(
                requestParam, queryWrapper);
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        List<LinkAccessStatsDO> listStatsByGroup = linkAccessStatsMapper.listStatsByGroup(
                requestParam);
        if (CollUtil.isEmpty(listStatsByGroup)) {
            return null;
        }
        // 基础访问数据
        LinkAccessStatsDO pvUvUidStatsByGroup = linkAccessLogsMapper.findPvUvUidStatsByGroup(
                requestParam);
        // 基础访问详情
        ...
        // 地区访问详情（仅国内）
        List<ShortLinkStatsLocateCNRespDTO> locateCnStats = new ArrayList<>();
        List<LinkLocateStatsDO> listedLocateByGroup = linkLocateStatsMapper.listLocateByGroup(
                requestParam);
        ...
        // 小时访问详情
        List<Integer> hourStats = new ArrayList<>();
        List<LinkAccessStatsDO> listHourStatsByGroup = linkAccessStatsMapper.listHourStatsByGroup(
                requestParam);
        for (int i = 0; i < 24; i++) {
            AtomicInteger hour = new AtomicInteger(i);
        ...
        // 高频访问IP详情
        List<ShortLinkStatsTopIpRespDTO> topIpStats = new ArrayList<>();
        List<HashMap<String, Object>> listTopIpByGroup = linkAccessLogsMapper.listTopIpByGroup(
                requestParam);
        ...
        // 一周访问详情
        List<Integer> weekdayStats = new ArrayList<>();
        List<LinkAccessStatsDO> listWeekdayStatsByGroup = linkAccessStatsMapper.listWeekdayStatsByGroup(
                requestParam);
        for (int i = 1; i < 8; i++) {
            AtomicInteger weekday = new AtomicInteger(i);
        ...
        // 操作系统访问详情
        List<ShortLinkStatsOsRespDTO> osStats = new ArrayList<>();
        List<HashMap<String, Object>> listOsStatsByGroup = linkOsStatsMapper.listOsStatsByGroup(
                requestParam);
        ...
        // 访问设备类型详情
        List<ShortLinkStatsDeviceRespDTO> deviceStats = new ArrayList<>();
        List<LinkDeviceStatsDO> listDeviceStatsByGroup = linkDeviceStatsMapper.listDeviceStatsByGroup(
                requestParam);
        ...
        // 访问网络类型详情
        List<ShortLinkStatsNetworkRespDTO> networkStats = new ArrayList<>();
        List<LinkNetworkStatsDO> listNetworkStatsByGroup = linkNetworkStatsMapper.listNetworkStatsByGroup(
                requestParam);
